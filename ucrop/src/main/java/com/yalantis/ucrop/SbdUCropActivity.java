...
public class SbdUCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sbd_ucrop_activity_photobox);
    ...
    private void setImageData(@NonNull Intent intent) {
        ...
        if (inputUri != null && outputUri != null) {
            try {
                outputUri = FileUtils.replaceOutputUri(SbdUCropActivity.this, isForbidCropGifWebp, inputUri, outputUri);
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mCompressQuality = intent.getIntExtra(UCrop.Options.EXTRA_COMPRESSION_QUALITY, SbdUCropActivity.DEFAULT_COMPRESS_QUALITY);
    ...
    private TransformImageView.TransformImageListener mImageListener = new TransformImageView.TransformImageListener() {
        ...
        public void onLoadComplete() {
            ...
            if (getIntent().getBooleanExtra(UCrop.Options.EXTRA_CROP_FORBID_GIF_WEBP, false)) {
                ...
                String mimeType = FileUtils.getMimeTypeFromMediaContentUri(SbdUCropActivity.this, inputUri);
